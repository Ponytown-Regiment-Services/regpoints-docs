...
banner:
  content: |
      This guide will be outdated soon, but will be updated when the new system will be out.
      Look at <a href="https://docs.regpoints.fr/blog/hello-world/">our latest blog post</a> for more info about the new system.
---
