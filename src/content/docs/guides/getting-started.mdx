...
### Adding staff members to the dashboard
...
Go to the "Invites & Access" category on the sidebar.
...
Once you have setup the permissions for each staffs, you can invite them by sending them the invite link attributed.
