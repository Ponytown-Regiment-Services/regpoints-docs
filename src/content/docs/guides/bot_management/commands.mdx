...
banner:
    content: |
        This page contains commands that are not released yet, and may be subject to change.
        <br>
        The documentation regarding the bot commands is currently missing images.
---
...
| [`/economy enable`](#economy-commands-set) | Enable the economy system. |
| [`/economy disable`](#economy-commands-set) | Disable the economy system. |
...
| [`/add-money`](#economy-commands) | Give money to a user. |
| [`/remove-money`](#economy-commands) | Take money from a user. |
| [`/economy symbol`](#economy-commands) | Set the economy symbol. |
...
### Economy commands
The economy commands allow you to manage the economy system for your regiment directly from Discord.
The `/add-money` and `/remove-money` commands allow you to give or take money from a user, while the `/economy symbol` command allows you to set the economy symbol.
...
:::note
The symbol must be an one emoji or one character symbol.

You can also use a custom Disord emoji by typing the emoji name between colons, like this: `:emoji_name:`.
:::
...
| [`/give-money`](#economy-user-commands) | Give money to a user, and take the same amount from you. |
| [`/balance`](#economy-user-commands) | Check your balance. |
